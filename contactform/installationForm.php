...
// Version: Responsive Contact Form V3.1 - Installer
// Copyright (c) 2019 Stuart Cochrane
// 
        ...
        <div style="width:98%;max-width:550px;">
            <form id="installationForm" class="form-horizontal" method="post" action="<?php echo INSTALLFILE; ?>">
                <fieldset class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="USEGDPR" class="col-sm-3 control-label">Require consent (GDPR)</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-list-ul fa-fw"></i></span>
...
>>>>>>> 8329b7b5bdf2157a7b1760d295b1b7723b40c1c2
</html>