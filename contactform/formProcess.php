...
function checkFieldsExist($form_fields) {
    ...
    if($errors > 0) {
        echo "There's a problem reading the form fields.";
        exit(1);
    }
}
...
function checkRecaptcha() {
    require CONFIGFILE;
    if($use_recaptcha == "yes" && !isset($_POST['g-recaptcha-response'])) {
        echo "There's a problem with the anti-spam reCaptcha.";
        exit(1);
    }
